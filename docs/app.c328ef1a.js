...
var _default = {
  ...
  mounted() {
    // Blur listener
    this.clickListener = document.addEventListener('click', e => this.blur(e)); // Keydown listener
  ...
  methods: {
    ...
    blur(e) {
      ...
      if (!this.active || this.$el.contains(e.target)) return; // Blur
    ...
    keydown(e) {
      ...
      if (!this.active || !this.$el.contains(e.target)) return; // Blur on escape
      ...
      if (e.key === 'Escape') {
        ...
        this.toggle();
          ...
          // Get focus data
          const focus = this.focusables(); // Focus on next focusable
    ...
    focusables() {
      // Get all focusables
      const focusables = this.$el.querySelectorAll('button, [href]'); // Get current focus index
...
exports.default = _default;
        var $9b5734 = exports.default || module.exports;
      
      if (typeof $9b5734 === 'function') {
        $9b5734 = $9b5734.options;
      }
    
        /* template */
        Object.assign($9b5734, (function () {
          var render = function() {
  var _vm = this
    ...
    _c(
      ...
      [
        _vm.label
          ...
          : _vm._e(),
        _vm._v(" "),
        _c("strong", { staticClass: "dropdown-value" }, [
          _vm._v(_vm._s(_vm.value))
        ]),
        _vm._v(" "),
        _c("i", {
          staticClass: "icon arrow-down flip",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9b5734', $9b5734);
          } else {
            api.reload('$9b5734', $9b5734);
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/base-64/base64.js":[function(require,module,exports) {
var global = arguments[3];
var define;
...
},{}],"entities.js":[function(require,module,exports) {
"use strict";
...
class Input {
  ...
  static base64Encode(str) {
    return _base.default.encode(str);
  }
  /**
...
},{"base-64":"../node_modules/base-64/base64.js","./entities":"entities.js"}],"modes.js":[function(require,module,exports) {
"use strict";
...
/**
 * String processing modes and their associated labels and utility methods
 */
const Modes = {
  'encodeHtml': {
    label: 'Encode HTML',
...
var _default = Modes;
exports.default = _default;
},{}],"components/Toolbelt.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted() {
    // Keydown listener
    this.keyListener = document.addEventListener('keydown', e => this.keydown(e)); // Initialize copy to clipboard button
  ...
  methods: {
    ...
    process() {
      // No input
      if (!this.input) return; // Method doesn't exist

      if (!_input.default[this.mode]) {
      ...
      try {
        this.output = _input.default[this.mode](this.input);
      } catch (e) {
        this.output = e;
      }
    },
    ...
    shortcutLabel(shortcut) {
      return shortcut.replace(/⇧/g, ' Shift ').replace(/⌃/g, ' Control ').replace(/⌘/g, ' Command ').replace(/⌥/g, ' Alt ').replace(/⎋/g, ' Escape ').replace(/⏎/g, ' Enter ');
    },
    ...
    keydown(e) {
      // Control not pressed
      if (!e.ctrlKey) return; // Mode selection
...
exports.default = _default;
        var $46c292 = exports.default || module.exports;
      
      if (typeof $46c292 === 'function') {
        $46c292 = $46c292.options;
      }
    
        /* template */
        Object.assign($46c292, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("main", { staticClass: "toolbelt", attrs: { role: "main" } }, [
    _c("div", { staticClass: "in" }, [
      _c("textarea", {
        ...
        ref: "input",
        staticClass: "input tall no-resize code",
      ...
      [
        _c(
          "dropdown",
          {
            ref: "modeMenu",
            attrs: {
              value: _vm.modes[_vm.mode].label,
              label: "Mode",
              size: "lg"
            }
          },
          [
            _c(
              "ul",
              { staticClass: "menu unlist" },
              _vm._l(Object.keys(_vm.modes), function(modeKey) {
                return _c("li", { key: modeKey }, [
                  _c(
                    "button",
                    {
                    ...
                    [
                      _c(
                        "span",
                        {
                          class:
                            "menu-label" +
                            (_vm.mode === modeKey ? " selected" : "")
                        },
                        [_vm._v(_vm._s(_vm.modes[modeKey].label))]
                      ),
                      _vm._v(" "),
                      _c("span", { staticClass: "shortcut" }, [
                        _c("span", { attrs: { "aria-hidden": "true" } }, [
                          _vm._v(_vm._s(_vm.modes[modeKey].shortcut))
                        ]),
                        _vm._v(" "),
                        _c("span", { staticClass: "sr-only" }, [
                          _vm._v(
                            "Keyboard shortcut: " +
                              _vm._s(
                                _vm.shortcutLabel(_vm.modes[modeKey].shortcut)
                              )
                          )
                        ])
                      ])
        ...
        _c(
          ...
          {
            ref: "copyBtn",
            staticClass: "copy-btn btn sm pill info tooltip-anchor",
            attrs: { "data-clipboard-target": "#out" }
          },
          [
            _c("span", { staticClass: "label" }, [_vm._v("Copy")]),
            _vm._v(" "),
            _c("i", {
            ...
            _vm._m(0),
            _vm._v(" "),
            _c("span", { staticClass: "tooltip tooltip-copied fade-in" }, [
              _vm._v("Copied")
            ])
          ]
        ),
    ...
    _c("div", { staticClass: "out" }, [
      _c("textarea", {
        ...
        ref: "output",
        staticClass: "input tall no-resize code",
        attrs: { id: "out", placeholder: "Output", readonly: "" },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { staticClass: "tooltip fade-in" }, [
      _vm._v("Copy output to clipboard "),
      _c("span", { staticClass: "shortcut light" }, [_vm._v("⌃⏎")])
    ])
  }
]
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$46c292', $46c292);
          } else {
            api.reload('$46c292', $46c292);
          }
        }
...
},{"clipboard":"../node_modules/clipboard/dist/clipboard.js","./Dropdown.vue":"components/Dropdown.vue","../input":"input.js","../modes":"modes.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/App.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $0c09d6 = exports.default || module.exports;
      
      if (typeof $0c09d6 === 'function') {
        $0c09d6 = $0c09d6.options;
      }
    
        /* template */
        Object.assign($0c09d6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("toolbelt"),
      _vm._v(" "),
      _c("footer", { staticClass: "footer", attrs: { role: "contentinfo" } }, [
        _vm._m(0),
        _vm._v(" "),
        _vm._m(1),
        _vm._v(" "),
        _c("ul", { staticClass: "footer-links unlist" }, [
          _c("li", [
            _c("a", { attrs: { href: "https://github.com/sprtus/toolbelt" } }, [
              _c(
                "svg",
                {
                  attrs: {
              ...
              _c(
                "span",
                { staticClass: "label", attrs: { "aria-hidden": "true" } },
                [_vm._v("GitHub")]
              ),
              _vm._v(" "),
          ...
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "https://glyphs.io/" } }, [
              _c(
                "svg",
                {
                  attrs: {
                ...
                [
                  _c("path", {
                    attrs: {
                      "fill-rule": "evenodd",
                      d:
                        "M16,0 L24,0 L24,39 L16,39 L16,0 Z M40,25 L48,25 L48,64 L40,64 L40,25 Z M0,16 L15,16 L15,24 L0,24 L0,16 Z M40,0 L48,0 L48,15 L40,15 L40,0 Z M16,49 L24,49 L24,64 L16,64 L16,49 Z M49,40 L64,40 L64,48 L49,48 L49,40 Z M25,16 L64,16 L64,24 L25,24 L25,16 Z M0,40 L39,40 L39,48 L0,48 L0,40 Z"
                    }
                  })
                ]
              ),
              ...
              _vm._v(" "),
              _c("span", { staticClass: "sr-only" }, [_vm._v("Glyphs")])
            ])
          ]),
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "https://screem.io/" } }, [
              _c(
                "svg",
                {
                  attrs: {
                ...
                [
                  _c("g", { attrs: { "fill-rule": "evenodd" } }, [
                    _c("path", {
                      attrs: {
                        d:
                          "M0,64 L64,64 L64,0 L0,0 L0,64 Z M4,60 L60,60 L60,4 L4,4 L4,60 Z"
                      }
                    }),
                    _c("path", {
                      attrs: {
                        d:
                          "M8,56 L8,52 L56,52 L56,56 L8,56 Z M8,48 L8,16 L12,16 L12,48 L8,48 Z M16,48 L16,40 L20,40 L20,48 L16,48 Z M24,48 L24,40 L28,40 L28,48 L24,48 Z M32,48 L32,30 L36,30 L36,48 L32,48 Z M40,48 L40,40 L44,40 L44,48 L40,48 Z M48,48 L48,40 L52,40 L52,48 L48,48 Z"
                      }
                    })
                  ])
                ]
              ...
              _vm._v(" "),
              _c("span", { staticClass: "sr-only" }, [_vm._v("Screem")])
            ])
          ])
        ])
      ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "colophon" }, [
      _c("strong", [_vm._v("Toolbelt")]),
      _vm._v(" by "),
      _c("a", { attrs: { href: "https://twitter.com/kyleschaeffer" } }, [
        _vm._v("@kyleschaeffer")
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "social" }, [
      _c(
        "a",
        {
          staticClass: "twitter-follow-button",
          attrs: {
            href: "https://twitter.com/kyleschaeffer?ref_src=twsrc%5Etfw",
            "data-show-screen-name": "false",
            "data-dnt": "true",
            "data-show-count": "false"
          }
        },
        [_vm._v("Follow @kyleschaeffer")]
      ),
      _vm._v(" "),
      _c(
        "a",
        {
          ...
          attrs: {
            ...
            "data-text":
              "Nice tool for encoding, decoding, and escaping strings",
            "data-url": "https://tbelt.io",
            "data-via": "kyleschaeffer",
            "data-related": "kyleschaeffer",
            "data-dnt": "true"
          }
        },
        [_vm._v("Tweet")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0c09d6', $0c09d6);
          } else {
            api.reload('$0c09d6', $0c09d6);
          }
        }
...
},{"./components/App.vue":"components/App.vue","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
